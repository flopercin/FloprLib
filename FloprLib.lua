...
Flopr.Name = "Flopr"
if syn then
	syn.protect_gui(Flopr)
	Flopr.Parent = game.CoreGui
else
...
function FloprLib:IsRunning()
	if gethui then
		...
		return Flopr.Parent == game:GetService("CoreGui")
	end
end
...
local function AddConnection(Signal, Function)
	...
	table.insert(FloprLib.Connections, SignalConnect)
	return SignalConnect
end

task.spawn(function()
	while FloprLib:IsRunning() do
		wait()
	end
	for _, Connection in next, FloprLib.Connections do
...
local function CreateElement(ElementName, ElementFunction)
	FloprLib.Elements[ElementName] = function(...)
		return ElementFunction(...)
	end
end

local function MakeElement(ElementName, ...)
	local NewElement = FloprLib.Elements[ElementName](...)
	return NewElement
end
...
local function AddThemeObject(Object, Type)
	if not FloprLib.ThemeObjects[Type] then
		FloprLib.ThemeObjects[Type] = {}
	end    
	table.insert(FloprLib.ThemeObjects[Type], Object)
	Object[ReturnProperty(Object)] = FloprLib.Themes[FloprLib.SelectedTheme][Type]
	return Object
end    

local function SetTheme()
	for Name, Type in pairs(FloprLib.ThemeObjects) do
		for _, Object in pairs(Type) do
			Object[ReturnProperty(Object)] = FloprLib.Themes[FloprLib.SelectedTheme][Name]
		end    
	end    
end
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a, b)
		if FloprLib.Flags[a] then
			spawn(function() 
				if FloprLib.Flags[a].Type == "Colorpicker" then
					FloprLib.Flags[a]:Set(UnpackColor(b))
				else
					FloprLib.Flags[a]:Set(b)
				end    
			end)
		else
			warn("FloprLib Config Loader - Could not find ", a, b)
		end
	end)
end
...
local function SaveCfg(Name)
	local Data = {}
	for i, v in pairs(FloprLib.Flags) do
		if v.Save then
...
function FloprLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "FloprLib"
	WindowConfig.ConfigFolder = WindowConfig.ConfigFolder or WindowConfig.Name
	WindowConfig.SaveConfig = WindowConfig.SaveConfig or false
	WindowConfig.HidePremium = WindowConfig.HidePremium or false
	if WindowConfig.IntroEnabled == nil then WindowConfig.IntroEnabled = true end
	WindowConfig.IntroText = WindowConfig.IntroText or "FloprLib"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://8834748103"
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://8834748103"
	FloprLib.Folder = WindowConfig.ConfigFolder
	FloprLib.SaveCfg = WindowConfig.SaveConfig
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddButton(ButtonConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(FloprLib.Themes[FloprLib.SelectedTheme].Second.R * 255 + 3, FloprLib.Themes[FloprLib.SelectedTheme].Second.G * 255 + 3, FloprLib.Themes[FloprLib.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = FloprLib.Themes[FloprLib.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(FloprLib.Themes[FloprLib.SelectedTheme].Second.R * 255 + 6, FloprLib.Themes[FloprLib.SelectedTheme].Second.G * 255 + 6, FloprLib.Themes[FloprLib.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)
			...
			function ElementFunction:AddToggle(ToggleConfig)
				...
				function Toggle:Set(Value)
					Toggle.Value = Value
					TweenService:Create(ToggleBox, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Toggle.Value and ToggleConfig.Color or FloprLib.Themes.Default.Divider}):Play()
					TweenService:Create(ToggleBox.Stroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Color = Toggle.Value and ToggleConfig.Color or FloprLib.Themes.Default.Stroke}):Play()
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(ToggleFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(FloprLib.Themes[FloprLib.SelectedTheme].Second.R * 255 + 3, FloprLib.Themes[FloprLib.SelectedTheme].Second.G * 255 + 3, FloprLib.Themes[FloprLib.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(ToggleFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = FloprLib.Themes[FloprLib.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(ToggleFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(FloprLib.Themes[FloprLib.SelectedTheme].Second.R * 255 + 6, FloprLib.Themes[FloprLib.SelectedTheme].Second.G * 255 + 6, FloprLib.Themes[FloprLib.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)

				if ToggleConfig.Flag then FloprLib.Flags[ToggleConfig.Flag] = Toggle end	
				return Toggle
			end  
			function ElementFunction:AddSlider(SliderConfig)
				...
				if SliderConfig.Flag then FloprLib.Flags[SliderConfig.Flag] = Slider end
				return Slider
			end  
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				if DropdownConfig.Flag then FloprLib.Flags[DropdownConfig.Flag] = Dropdown end
				return Dropdown
			end
			function ElementFunction:AddBind(BindConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(FloprLib.Themes[FloprLib.SelectedTheme].Second.R * 255 + 3, FloprLib.Themes[FloprLib.SelectedTheme].Second.G * 255 + 3, FloprLib.Themes[FloprLib.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = FloprLib.Themes[FloprLib.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(FloprLib.Themes[FloprLib.SelectedTheme].Second.R * 255 + 6, FloprLib.Themes[FloprLib.SelectedTheme].Second.G * 255 + 6, FloprLib.Themes[FloprLib.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)
				...
				if BindConfig.Flag then FloprLib.Flags[BindConfig.Flag] = Bind end
				return Bind
			end  
			function ElementFunction:AddTextbox(TextboxConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(FloprLib.Themes[FloprLib.SelectedTheme].Second.R * 255 + 3, FloprLib.Themes[FloprLib.SelectedTheme].Second.G * 255 + 3, FloprLib.Themes[FloprLib.SelectedTheme].Second.B * 255 + 3)}):Play()
				end)

				AddConnection(Click.MouseLeave, function()
					TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = FloprLib.Themes[FloprLib.SelectedTheme].Second}):Play()
				end)
				...
				AddConnection(Click.MouseButton1Down, function()
					TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(FloprLib.Themes[FloprLib.SelectedTheme].Second.R * 255 + 6, FloprLib.Themes[FloprLib.SelectedTheme].Second.G * 255 + 6, FloprLib.Themes[FloprLib.SelectedTheme].Second.B * 255 + 6)}):Play()
				end)
			end 
